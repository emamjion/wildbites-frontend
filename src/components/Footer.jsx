      ...
      <div className="container mx-auto">
        ...
        <div className="pt-[104px] pb-[30px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[30px]">
          <div className="text-white">
            ...
            <p className="my-6">
              At Wildbites, we offer premium pet food made with high-quality to
              ensure optimal health for your furry friends.
            </p>
            {/* Social icon */}
          ...
          <div className="text-white">
            ...
            <p className="mb-8">
              <span>If you have any question. please contact us at</span>{" "}
              <span className="text-accent">wildbites@gmail.com</span>
            </p>
            <div>
        ...
        <div className="py-5">
          <p className="text-center text-[#a1a1a1]">
            &copy; wildbites. Made with ❤️ by{" "}
            <Link href={"https://codeclubitsolutions.com/"}>
